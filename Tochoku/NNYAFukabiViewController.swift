//
//  NNYAFukabiViewController.swift
//  Tochoku
//
...
class NNYAFukabiViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CellNNYA", for: indexPath) as! NNYASubCalendarCollectionViewCell
        let firstDayOfMonth = cal.date(from: components)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if dateLabel.text == dateFormatter.string(from: selectedDay!){
            let dateString = selectedDateFormatter.string(from: selectedDay!) + "\n"
            let cell = collectionView.cellForItem(at: indexPath) as! NNYASubCalendarCollectionViewCell
    ...
    @IBAction func myActionOkuru(){
        ...
        let okuruString = thisMonth + "\n" + tochokukaiString + yushinkaiString + thisMonthTochokuFukaString + thisMonthYushinFukaString + thisMonthTochokuKiboString + thisMonthYushinKiboString
        print (okuruString)
