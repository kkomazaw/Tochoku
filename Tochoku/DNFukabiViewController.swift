...
class DNFukabiViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CellDN", for: indexPath) as! DNSubCalendarCollectionViewCell
        let firstDayOfMonth = cal.date(from: components)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if dateLabel.text == dateFormatter.string(from: selectedDay!){
            let dateString = selectedDateFormatter.string(from: selectedDay!) + "\n"
            let cell = collectionView.cellForItem(at: indexPath) as! DNSubCalendarCollectionViewCell
    ...
    @IBAction func myActionOkuru(){
        ...
        let okuruString = thisMonth + "\n" + tochokukaiString + thisMonthTochokuFukaString + thisMonthTochokuKiboString
        print (okuruString)
