//
//  NNYASakuseiViewController.swift
//  Tochoku
//
//  Created by Matsui Keiji on 2018/10/25.
...
class NNYASakuseiViewController: UIViewController, UIPickerViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        tochokuSegment.selectedSegmentIndex = 2
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "NNYACell", for: indexPath) as! NNYACollectionViewCell
        let firstDayOfMonth = cal.date(from: components)
        let firstWeekday = cal.component(.weekday, from: firstDayOfMonth!)
        weekdayAdding = 2 - firstWeekday
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if dateLabel.text == dateFormatter.string(from: selectedDay!){
            ...
            let cell = collectionView.cellForItem(at: indexPath) as! NNYACollectionViewCell
    ...
    @IBAction func myActionNyuryokuKanryo(){
        ...
        for i in 0 ..< daysCountInMonth{
            ...
            case .kyujitsu:
                yusenScores.append((i + 1,.tochoku, Int(arc4random_uniform(100))))
            }//switch kyujitsuHeijitsuArray[i]
        }//for i in 0 ..< daysCountInMonth!
        ...
        for i in 0 ..< yusenScores.count{
            ...
            case .kyujitsu:
                yusenScores[i].yScore = 10
            }//switch kyujitsuHeijitsuArray[yusenScores[i].aDay - 1]
        }//for i in 0 ..< yusenScores.count
        for i in 0 ..< yusenScores.count{
            let a = yusenScores[i].aDay
            let b = yusenScores[i].type
...
}//class NNYASakuseiViewController
