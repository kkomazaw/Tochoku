//
//  YNNASakuseiViewController.swift
//  Tochoku
//
...
class YNNASakuseiViewController: UIViewController,UIPickerViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "YNNACell", for: indexPath) as! YNNACollectionViewCell
        let firstDayOfMonth = cal.date(from: components)
        let firstWeekday = cal.component(.weekday, from: firstDayOfMonth!)
        weekdayAdding = 2 - firstWeekday
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if dateLabel.text == dateFormatter.string(from: selectedDay!){
            ...
            let cell = collectionView.cellForItem(at: indexPath) as! YNNACollectionViewCell
